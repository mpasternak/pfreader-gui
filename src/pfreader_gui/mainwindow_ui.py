...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "In the list below, you will find USB devices containing PrismaFlex® data, if any. In case you connected new devices, they should show up automatically. You can also open individual LOX files by clicking \"Open file\" button below. "))
